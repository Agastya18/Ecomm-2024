...
import { useUpdateProductMutation,useGetSingleProductQuery } from '@/redux/slices/ProductApiSlice';
const EditProduct = () => {
    ...
    const handleSubmit = async(e) => {
        ...
        try {
         ...
         // const { data } = await createProduct(formData);
            const { data } = await updateProduct({data:formData, id:productId});
        ...
        useEffect(() => {
            if(product){
                ...
                setStock(product.product.countInStock)
                setDescription(product.product.description)
                //setFile(product.product.file)
            }
        }, [product])
  return (
    <AdminLayout>
      ...
      <div className="grid  gap-8 grid-cols-1">
        <div className="flex flex-col ">
          <div className="flex flex-col sm:flex-row items-center bg-blue-200 rounded-md">
            <h2 className="  md:ml-36 text-xl font-thin ">Update Product</h2>
            ...
            <div className="form">
              <div className="md:space-y-2 mb-3">
                ...
                <div className="flex items-center py-6">
                  <div className="w-[64px] h-auto mr-4 flex-none rounded-xl border overflow-hidden">
                 
                  <img src={product?.product.images[0]} alt="img" className=' w-15 object-cover' />
                  </div>
